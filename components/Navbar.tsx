    ...
    >
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 font-medium tracking-wide">
            ...
            <span className="hidden sm:inline text-white/90">
              A simpler way to explore options from independent Lending Partners
            </span>
            <span className="sm:hidden text-white/90 whitespace-nowrap">
              Explore Lending Partner options
            </span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 sm:justify-between sm:gap-0 h-[77px] sm:h-28">
          <Link
            href="/"
            onClick={() => analytics.navbarLogoClick()}
          ...
          <div className="hidden lg:flex items-center gap-8">
            <nav className="flex items-center gap-2.5" aria-label="Main Navigation">
              <Link href="/" onClick={() => analytics.navbarLinkClick('home')} className="px-3.5 py-2 text-[17px] lg:text-[18px] font-bold text-af-navy hover:text-af-blue rounded-xl hover:bg-af-blue-soft transition-all duration-150">
                Home
              </Link>
              <Link href="/#loan-solutions-section" onClick={() => analytics.navbarLinkClick('services')} className="px-3.5 py-2 text-[17px] lg:text-[18px] font-bold text-af-navy hover:text-af-blue rounded-xl hover:bg-af-blue-soft transition-all duration-150">
                Services
              </Link>
              <Link href="/#estimator-anchor" onClick={(e) => { analytics.navbarLinkClick('apply_now'); handleOptionsClick(e); }} className="px-3.5 py-2 text-[17px] lg:text-[18px] font-bold text-af-navy hover:text-af-blue rounded-xl hover:bg-af-blue-soft transition-all duration-150">
                Check Options
              </Link>
              <Link href="/blog" onClick={() => analytics.navbarLinkClick('blog')} className="px-3.5 py-2 text-[17px] lg:text-[18px] font-bold text-af-navy hover:text-af-blue rounded-xl hover:bg-af-blue-soft transition-all duration-150">
                Blog
              </Link>
            </nav>
          ...
          <div className="flex-shrink-0 flex lg:hidden items-center gap-1.5">
            <Link
              href="/#estimator-anchor"
              onClick={(e) => { analytics.navbarApplyClick('mobile'); handleOptionsClick(e); }}
            ...
            <a
              ...
              aria-label="Call Loan Streamline Pro"
              id="mobile-phone-cta"
            >
        ...
        <div className="lg:hidden border-t border-af-blue-ice bg-white/98 backdrop-blur-2xl animate-fadeIn py-6 px-4 shadow-2xl" id="mobile-menu-drawer">
          <div className="flex flex-col gap-4">
            <nav className="flex flex-col gap-1.5">
              ...
              <Link href="/#estimator-anchor" className="px-4 py-3 text-lg font-bold text-af-navy hover:bg-af-blue-ice/60 rounded-xl transition-colors" onClick={(e) => { analytics.navbarLinkClick('apply_now'); setIsOpen(false); handleOptionsClick(e); }}>Check Options</Link>
            ...
            <a href="tel:+18332890694" onClick={() => analytics.navbarCallClick('mobile')} className="flex items-center gap-4 p-4 rounded-2xl bg-af-blue-soft border border-af-blue-ice shadow-sm" id="mobile-menu-phone-call">
              ...
              <div>
                <span className="block text-xs font-bold text-pv-muted uppercase tracking-wider">Speak with LSP</span>
                <span className="block text-xl font-bold font-mono text-pv-primary mt-0.5">(833) 289-0694</span>
              </div>
            </a>
            ...
            <div className="text-center text-xs text-pv-muted px-4 mt-1">
              🔒 Technology Service • Independent Lending Partners • LSP Is Not a Lender
            </div>
          </div>
        </div>
      )}
